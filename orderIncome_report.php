...
$('#vehicleTbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/orderIncomeReport_handler.php?type=retrieveOrder',
...
$.ajax({
url: "handlers/orderIncomeReport_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
//x axis , y axis
doc.text(207, 215, "Order Income Details");
