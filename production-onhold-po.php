...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Production On hold </li>
        </ol>
    </nav>
  ...
  $(document).ready(function() {
    ...
    function datab_prod_order() {
        $('#productionTbl').DataTable({
            ...
            {
                url: 'handlers/production-onhold-po_handler.php?type=retrieveProductionOnHoldOrders',
                type: 'POST'
            },
            pageLength: 10,
            columns: [
        ...
        $('#productionViewModal').modal('show');
                ...
                return regexpr.test(value);
                    ...
                    function saveReason(){
                            ...
                            $.ajax({
                                url:"handlers/production-onhold-po_handler.php?type=addComment",
                                method: 'POST',
                                data: data,
                                processData: false,
                                contentType: false
            ...
            $.ajax({
            type: "POST",
            url: "handlers/production-onhold-po_handler.php?type=resume",
            data: {
