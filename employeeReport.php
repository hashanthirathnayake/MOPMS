...
<div class="card-body">
            ...
            <option value="2">Production Officer</option>
            <option value="3">Supervisor</option>
            <option value="4">Assistant</option>
            <option value="5">Delivery Officer</option>
                       ...
                       <form id="sales_order">
								...
								<div class="form-row">
									<div class="form-group col-md-3">
										...
										<input type="text" name="emp_jdate" placeholder="Date From" class="form-control datepicker" id="emp_jdate" > -->
									...
									<!-- <div class="form-group col-md-3">
										...
										<input type="date" name="emp_jdate" placeholder="Date To" class="form-control datepicker" id="jdate">
									</div> -->
        ...
        <div class="row">
                     ...
                     <div class="col-md-2">
                            <div class="form-group">
                                <!-- <label>select</label> -->
                                <!-- <input type="date" name="date_from" id="date_from"  placeholder="" class="form-control "> -->
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <!-- <label>Join date</label>
                                <input type="date" name="datepicker" id="datepicker" placeholder="" class="form-control"> -->
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
        ...
        serverSide:true,
            ...
            ajax:{
                url:'handlers/employeeReport_handler.php?type=retrieve',
            ...
            columns:[
                ...
                {data:"desig_id",name:"DESIGNATION"},
                {data:"emp_nic",name:"NIC"},
                {data:"emp_jdate",name:"JOIN_DATE"},
                {data:"emp_address",name:"ADDRESS"},
                {data:"emp_contact_no",name:"CONTACT_NO"},
                {data:"emp_email",name:"EMAIL"},
                
                {data:"emp_status",name:"STATUS"}
...
$.ajax({
url: "handlers/employeeReport_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["NO"], value["EMPLOYEE_NAME"], value["DESIGNATION"], value["NIC"] , value["JOIN_DATE"], value["ADDRESS"] , value["CONTACT_NO"] , value["EMAIL"] , value["STATUS"]   ]);
});
...
var head = [["No","Employee Name","Designation","Nic","Join Date","Address","Contact No","Email","Status"]];
...
// doc.addImage("", "JPEG", 200, 50, 200, 100);



doc.text(225,215,"Employee Details");
