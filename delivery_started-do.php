...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="pending_orders-do.php">Pendings</a></li>
...
<script>
    ...
    function datab_prod_order() {
        $('#productionTbl').DataTable({
            ...
            {
                url: 'handlers/delivery-started-do_handler.php?type=retrieveDeliveryStartedOrders',
                type: 'POST'   
            },
            pageLength: 10,
            columns: [
    ...
    function planItem(ord_detail_id) {
        ...
        var location = "http://localhost/mopms/assignResource-do.php?ord_detail_id=" + ord_detail_id;
...
//    console.log(ordId);
        $.ajax({
            type: "POST",
            url: "handlers/delivery-started-do_handler.php?type=completeDelivery",
            data: {
                deli_id : deli_id,
                // ordId: ordId,
            },
    ...
    function onHoldProduction(deli_id) {
        ...
        $.ajax({
        type: "POST",
        url: "handlers/delivery-started-do_handler.php?type=onholdDelivery",
        data: {
            deli_id : deli_id,
        },
        cache: false,
