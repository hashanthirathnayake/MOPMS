			...
			<div class="table-responsive">
                        <table class="table" id="Tbl">
							<thead class="thead-light text-dark">
								...
								<th scope="col">mac schdule id</th>
                                <th scope="col">ord detail id</th>
...
$('#Tbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/macScheduleReport_handler.php?type=retrieve',
                ...
                pageLength:10,
                columns:[
                    {data:"mac_sche_id",name:"mac_sche_id"},       //data-> data value coming from the backend name -> table fields
...
$.ajax({
url: "handlers/macScheduleReport_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["mac_sche_id"], value["ord_detail_id"], value["mac_id"], value["mac_name"] , value["reserved_from"], value["reserved_to"]  ]);
});
...
var head = [["Schedule No","Order Detail No","Mac No","Machine Name","Reserved From","Reserved To"]];
...
doc.text(225,215,"Machine Schedule");
doc.line(255, 230, 335, 230);
// doc.setFontSize(15);
