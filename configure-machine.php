...
$(document).ready(function(){
    ...
    $.ajax({
                url : "handlers/configure-machine_handler.php?type=getMachineName", 
                method : "GET",
            ...
            $.ajax({
                url : "handlers/configure-machine_handler.php?type=getProductName", 
                method : "GET",
                success : function(data){
                    data = JSON.parse(data);                    
                    data.forEach(row => {                          //db column name
        ...
        $(document).ready(function(){
            ...
            $("#MacConfigSave").click(function(){
                ...
                $.ajax({
                    url:"handlers/configure-machine_handler.php?type=saveMachineConfiguration",
                    method: 'POST',
                    data: data,
                    processData: false,
                    contentType: false
    ...
    function datab() {
        $('#macConfigTbl').DataTable({
            ...
            {
                url: 'handlers/configure-machine_handler.php?type=retrieve',
                type: 'POST'
            },
    ...
    function removeItem(macConfigId) {
        $.ajax({
                method: "POST",
                url: "handlers/configure-machine_handler.php?type=delete",
                //id        //user_id
                data: {
    ...
    function editItem(macConfigId) {
        ...
        $.ajax({
                method: "POST",
                url: "handlers/configure-machine_handler.php?type=loadEditForm",
                data: {
                    id: macConfigId
                }
            })
