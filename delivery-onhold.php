  ...
  $(document).ready(function() {
    ...
    function datab_prod_order() {
        $('#productionTbl').DataTable({
            ...
            {
                url: 'handlers/delivery-onhold_handler.php?type=retrieveOnholdDelivery',
                type: 'POST'
            },
            pageLength: 10,
            columns: [
        ...
        function reason(deliId) {
            ...
            function saveCmnt(){
                ...
                if(!$("#frmDeli").valid()){
                                ...
                                $.ajax({
                                    url:"handlers/delivery-onhold_handler.php?type=addComent",
                                    method: 'POST',
                                    data: data,
                ...
                $.ajax({
                type: "POST",
                url: "handlers/delivery-onhold_handler.php?type=resume",
                data: {
                    deli_id : deli_id,
                },
                cache: false,
