...
$('#vehicleTbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/orderIncomeReport-assis_handler.php?type=retrieveOrder',
...
$.ajax({
url: "handlers/orderIncomeReport-assis_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["ord_id"], value["customer_name"], value["ord_place_date"], value["ord_net_total"]  ]);
});
...
var head = [["Order No","Customer Name","Order Place Date","Net Total"]];
...
//x axis , y axis
doc.text(220, 215, "Order Income Details");
