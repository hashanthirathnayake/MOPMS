			...
			<div class="table-responsive">
                        <table class="table" id="productTbl">
                            ...
                            <th scope="col"> Customer Code</th>
                                ...
                                <th scope="col">Order Place On</th>
								<th scope="col">Require On</th>
...
$('#productTbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/customerOrderReport_handler.php?type=retrieve',
                ...
                columns:[
                    ...
                    {data:"CUTOMER_NAME",name:"CUTOMER_NAME"}, //data-> data value coming from the backend name -> table fields

                {data:"ord_place_date",name:"ord_place_date"},
                {data:"ord_deli_date",name:"ord_deli_date"},
                {data:"ord_status",name:"ord_status"},
                {data:"ord_deli_address",name:"ord_deli_address"},
                {data:"cus_phone_no",name:"cus_phone_no"}
...
$.ajax({
url: "handlers/customerOrderReport_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["cus_id"],value["CUTOMER_NAME"], value["ord_place_date"], value["ord_deli_date"], value["ord_status"] , value["ord_deli_address"] , value["cus_phone_no"]  ]);
});
...
var head = [["Id","Customer Name","Order Place  On","Require On","Order Status","Delivery Address","Contact No"]];
...
doc.text(225,215,"Customer Details");
