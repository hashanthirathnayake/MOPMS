                                    ...
                                    if(mysqli_num_rows($result2) > 0){
                                        ...
                                        echo "<tr>
                                                <td class='grad' style='padding-top:10px; padding-bottom:10px; text-align:right;' colspan='100%'>
                                                    <a href='http://localhost/mopms/assignDelivery-do.php?order_id=".$row['ord_id']."' class='btn btn-sm btn-success ".(($dm || !$btnView) ? "d-none" : "")."'>  
...
//    window.open(configMacUrl,"_blank");
   var location = "http://localhost/mopms/assignDelivery-do.php?ord_id="+ord_id;
