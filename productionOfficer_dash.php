...
<script src="js/demo/product-pie-chart-proOfficer.js"></script>
<script src="js/demo/machine-plant-bar-chart-proOfficer.js"></script>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-pie pt-4">
                            <canvas id="pieChart"></canvas> <!--  pieChart -->
