                                         ...
                                         <!-- <div class="col-md-6"> -->
                                          <form action="#" id="macScheduleFrm">
                                                ...
                                                <!-- <div class="col-md-6"> -->
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="example-text-input" min="#placeDate"  class="col-4 col-form-label">Machine Reserved From<span class="text-danger">*</span></label>
                                                                <div class="col-8">
             ...
             <script>
                            ...
                            // $(document).ready(function(){
                                    ...
                                    $("#reserveMachineSave").click(function(){
                                        ...
                                        $("#macScheduleFrm").validate({
                                            ...
                                            messages:{
                                                ...
                                                macReservedFrom:{
                                                    ...
                                                    greaterThan:"select order place date or grater date",
                                                    // min: "Please enter  Order Place date or above date."
                                                    // minDate:"min date should order place date"
                                        ...
                                        $.ajax({
                                            url:  "handlers/plan-production-po_handler.php?type=addScheduleList",
                                            method: 'POST',
                                            data: data,
                                            processData: false,
                                            contentType: false
                                        ...
                                        .done(function(data){
                                            ...
                                            window.location.replace("http://localhost/mopms/realProduction-po.php");
                                ...
                                // });
                                    ...
                                    function datab(machineId) {
                                        ...
                                        $('#machineScheduleTbl').DataTable({
                                            ...
                                            {
                                                url: 'handlers/plan-production-po_handler.php?type=retrieveSchedule',
                                                type: 'POST',
                                                data: {
                                                    machineId: machineId
                                                },
