...
<script>
    ...
    function datab() {
        $('#Tbl').DataTable({
            ...
            {
                url: 'handlers/delivery-schedule_handler.php?type=retrieveDeliveryScheduledList',
            ...
            columnDefs: [{
                "targets": 9, //tells DataTables which column(s) the definition should be applied to
                "data": "deli_id",
    ...
    function startedDelivery(deli_id) {
        ...
        $.ajax({
            type: "POST",
            url: "handlers/delivery-schedule_handler.php?type=startDelivery",
            data: {
                deli_id : deli_id,
            },
            cache: false,
