<?php
 require('handlers/config.php'); 
   ...
   if(isset($_SESSION['usr_name'])){
     if(($_SESSION['user_cat_id'])!=6){          ////change below side bar, top bar according inside php tag to user
        //for the user cat id=6 for pro officer
...
<body id="page-top">
 ...
 <!-- <div id="wrapper"> -->
            ...
            <?php 
            require_once('sidebar_productionOfficer.php');      //change according to user
            ?>
         <?php 
         require_once('topbar_productionOfficer.php');  //change according to user
         ?>
