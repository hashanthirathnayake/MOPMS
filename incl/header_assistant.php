<?php
 require('handlers/config.php'); 
   ...
   if(isset($_SESSION['usr_name'])){
                    //  != not equal
     if(($_SESSION['user_cat_id'])!=5){       //change  end of this file also
        //for the user cat id=1 for admin
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php 
            require_once('sidebar_assistant.php');
            ?>
        <?php 
         require_once('topbar_assistant.php');
         ?>
