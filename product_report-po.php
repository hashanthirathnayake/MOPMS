...
<!-- 
                    <option value="Building items">Building </option>
                    <option value="drainage & sanitary items">Drainage</option>
                    <option value="garden items">Garden</option>
...
$('#productTbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/productReport-po_handler.php?type=retrieveProduct',
                ...
                pageLength:10,
                columns:[
                    {data:"pro_code",name:"PRO_CODE"}, //data-> data value coming from the backend name -> table fields

                {data:"pro_cat_name",name:"CAT_NAME"},
                {data:"pro_name",name:"PRO_NAME"},
                {data:"pro_des",name:"DESCRIPT"},
                {data:"pro_unit_price",name:"PRICE"}
...
$.ajax({
url: "handlers/productReport-po_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["pro_code"], value["pro_cat_name"], value["pro_name"], value["pro_des"] , value["pro_unit_price"]  ]);
});
...
var head = [["Product Code","Product category","Product","Description","Unit Price"]];
...
// doc.addImage("", "JPEG", 100, 80, 200, 100);

// doc.addImage("", "JPEG", 45, 45, 200, 100);

doc.text(225,215,"Product Details");
doc.line(255, 230, 335, 230);
// doc.setFontSize(15);
