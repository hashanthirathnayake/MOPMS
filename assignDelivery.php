        ...
        <div class="card-body p-3 pt-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td>Placed on</td>
                                    <td><span id="deliPlaceDate" name="deliPlaceDate"></span></td>
                                </tr>
                                <tr>
                                    <td>Delivery required on</td>
                                    <td><span id="deliReqDate" name="deliReqDate"></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <form action="#" id="deliveryScheduleForm">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Select Vehicle<span class="text-danger">*</span></label>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label"  >Select Driver <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Delivery start date<span class="text-danger">*</span></label>
                            <div class="col-7">
                                <input required type="date" name="startDate" id="startDate" placeholder="Delivery start date" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">Delivery end date<span class="text-danger">*</span></label>
                            <div class="col-7">
                    ...
                    <div class="col-sm-12">
                        <div class="ml-lg-auto text-right">
                            ...
                            <a href="javascript:void(0)" id="assignDelivery" name="assignDelivery"  class="btn btn-success">Save Schedule</a>
                        </div>                           <!-- onclick="saveDelivery()"  -->
                    </div>
                </div>
            </form>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "handlers/assignDelivery_handler.php?type=getVehicle",
            method: "GET",
        ...
        $.ajax({
            url: "handlers/assignDelivery_handler.php?type=getDriver",
            method: "GET",
            success: function(data) {
                data = JSON.parse(data);
                data.forEach(row => { //db column name
    ...
    function loadOrderDetail() {
        ...
        $.ajax({
                method: 'POST',
                url: "handlers/assignDelivery_handler.php?type=viewOrderDetail",
                data: {
                    id: id
                },
            })
    ...
    function loadDetailTable(orderId) {
        ...
        $('#orderDetailTable').DataTable({
            ...
            {
                url: 'handlers/assignDelivery_handler.php?type=retrieveOrderDetails',
                type: 'POST',
                data: {
                    order_id: orderId
                },
    ...
    function loadVehicleSchedules(vehicleId) {
        ...
        $('#vehicleTable').DataTable({
            ...
            ajax: //to specify the URL where DataTables should get its Ajax data from
            {
                url: 'handlers/assignDelivery_handler.php?type=retrieveVehicleSchedules',
                type: 'POST',
                data: {
    ...
    function loadDriverSchedules(driverId) {
        ...
        $('#driverTable').DataTable({
            ...
            ajax: //to specify the URL where DataTables should get its Ajax data from
            {
                url: 'handlers/assignDelivery_handler.php?type=retrieveDriverSchedules',
                type: 'POST',
                data: {
                    driver_id: driverId
                },
    ...
    //         $.ajax({
    //                 method: "POST",
    //                 url: "handlers/assignDelivery_handler.php?type=saveDelivery",
    //                 data: f,
    //                 contentType: false,
    //                 processData: false,
    ...
    //             })
    //             .done(function(data) {
    //                 location.replace('http://localhost/mopms/pending_orders.php');
    //             });
    ...
    //  validation
            ...
            $("#deliveryScheduleForm").validate({
                rules:{
                    ...
                    endDate:{
                        required: true,
                        // greaterThan: '#startDate'   //id of the input box
                    }
                ...
                messages:{
                    ...
                    startDate:{
                        ...
                        greaterThan:"please enter greater date"
                    },
            ...
            if(!$("#deliveryScheduleForm").valid()){
                return false;
            }

            data = new FormData($('#deliveryScheduleForm')[0]);
