...
<script>
    ...
    function getproductlist() {
        ...
        $.ajax({
            url: "handlers/order-aa-assis_handler.php?type=getProductName",
            method: "GET",
    ...
    function getcustomerlist() {
        ...
        $.ajax({
            url: "handlers/order-aa-assis_handler.php?type=getCustomerName",
            method: "GET",
            success: function(data) {
                data = JSON.parse(data);
    ...
    function addproduct() {
        var addproducturl = "http://localhost/mopms/product2-customize-assis.php";  //url for navigation page
        window.open(addproducturl, "_blank");  //open in another tab
    }

    function addCustomer() {

        var addCustomerUrl = "http://localhost/mopms/individual-assis.php";
    ...
    function loadProductDetailsById(productId) {
        $.ajax({
            url: "handlers/order-aa-assis_handler.php?type=loadProductDetails",
            method: "POST",
            data: {
                id: productId
            },
    ...
    $("#btnSaveOrder").click(function() {
        ...
        $.ajax({
                method: "POST",
                url: "handlers/order-aa-assis_handler.php?type=addOrder",
                data: f,
                contentType: false,
                processData: false,
            ...
            .done(function(data) {
                ...
                // location.replace('http://localhost/mopms/production-1-test-33.php');  //this  link active in admin //here comment
