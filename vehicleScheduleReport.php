			...
			<div class="table-responsive">
                        <table class="table" id="Tbl">
							<thead class="thead-light text-dark">
                                ...
                                <th scope="col"> Delivery Start on</th>
                                <th scope="col">Dlivery end on</th>
...
$('#Tbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/vechicleScheduleReport_handler.php?type=retrieve',
                ...
                pageLength:10,
                columns:[
                    {data:"NO",name:"NO"},       //data-> data value coming from the backend name -> table fields
...
$.ajax({
url: "handlers/vechicleScheduleReport_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["NO"], value["veh_no"], value["veh_type"], value["employee_name"] , value["start_date"], value["end_date"],value["status"]  ]);
});
...
var head = [["Delivery No","Vehicle No","Vehicle type","Employee Name","Start on","End on","Status"]];
...
// doc.addImage("", "JPEG", 45, 45, 200, 100);
 ...
 //x axis , y axis
doc.text(202,205,"Vehicle Driver Schedule");
doc.line(255, 230, 335, 230);
// doc.setFontSize(15);
