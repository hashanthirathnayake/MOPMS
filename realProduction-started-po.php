...
<script>
    ...
    function datab_prod_order() {
        $('#productionTbl').DataTable({
            ...
            {
                url: 'handlers/realProduction-po_handler.php?type=retrieveProductionStartedOrders',
                type: 'POST'
            },
            pageLength: 10,
            columns: [
    ...
    function CompleteProductionButton(ordDetailId) {
        ...
        $.ajax({
            type: "POST",
            url: "handlers/realProduction-po_handler.php?type=completeProduction",
            data: {
    ...
    function onHoldProduction(ordDetailId) {
        ...
        $.ajax({
        type: "POST",
        url: "handlers/realProduction-po_handler.php?type=onholdProduction",
        data: {
            orderDetailId : ordDetailId,
        },
        cache: false,
