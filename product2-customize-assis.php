...
<!-- Begin Page Content -->
 ...
 <script>    
      ...
      //for suggedt pro name when srach
        ...
        $("#saveProduct").click(function(){
            ...
            $.ajax({
                url:"handlers/product2-customize-assis_handler.php?type=saveProduct",
                method: 'POST',
                data: data,
                processData: false,
                contentType: false
            ...
            .done(function(data){
              ...
              $(document).ready(function(){
                  ...
                  $.ajax({
                      url : "handlers/product2-customize-assis_handler.php?type=getProductCategory", 
                      method : "GET",
          ...
          function datab() {
            $('#productTbl').DataTable({
                    ...
                    {
                        url: 'handlers/product2-customize-assis_handler.php?type=retrieveProduct',
                        type:'POST'
                    },
      ...
      $(document).ready(function(){
            ...
            function removeItem(pro_code){
              $.ajax({
                method:"POST",
                url:"handlers/product2-customize-assis_handler.php?type=deleteProduct",
                        //id        //user_id
    ...
    function editItem(pro_code) {
        ...
        $.ajax({
                method: "POST",
                url: "handlers/product2-customize-assis_handler.php?type=loadEditForm",
                data: {
                    id: pro_code
                }
            })
 ...
 function viewItem(pro_code) {
        ...
        $.ajax({
                method: "POST",
                url: "handlers/product2-customize-assis_handler.php?type=viewProduct",
                data: {
                  pro_code: pro_code
                },
            })
