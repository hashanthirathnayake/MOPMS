...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="pending_orders.php">Pending</a></li>
            <li class="breadcrumb-item active" aria-current="page">Delivery Completed</li>
        </ol>
    </nav>
    ...
    <div class="card mt-3">
        <div class="card-header bg-light">
            <h5>Delivery Completed Order List</h5>
        </div>
  ...
  $(document).ready(function() {
    ...
    function datab_prod_order() {
        $('#productionTbl').DataTable({
            ...
            {
                url: 'handlers/delivery-completed_handler.php?type=retrieveDeliveryCompletedOrders',
                type: 'POST'
            },
            pageLength: 10,
            columns: [
        ...
        function remark(deliId) {
             //hiden field id 
                ...
                function saveCmnt(deliId){
                    ...
                    $.ajax({
                        url:"handlers/delivery-completed_handler.php?type=addComent",
                        method: 'POST',
                        data: data,
                        processData: false,
                        contentType: false
                                        ...
                                        <div class="form-group row mb-0">
                                                  <div class="ml-lg-auto text-right">
                                                          ...
                                                          <button  type="button"    onclick="saveCmnt()"   id="btnDeliSave" class="btn btn-success">Save </button>
                                                                                                    <!-- onclick="saveQty()"   data-dismiss="modal" -->
