...
?>
     ...
     <div class="container-fluid">
         ...
         <div class="card-body">
             ...
             <!-- <div>
                 <select name="vehicleType" id="vehicle-type">
     ...
     <script>
         ...
         function datab() {
             $('#vehicleTbl').DataTable({
                 ...
                 // rowId: 'id',
                 ajax: {
                     url: 'handlers/vehicleReport-do_handler.php?type=retrieveVehicle',
         ...
         function pdf() {
             ...
             $.ajax({
                 url: "handlers/vehicleReport-do_handler.php?type=retrieveReportDetails",
                 type: "POST"
             }).done(function(data) {
                 ...
                 $.each(arr, function(index, value) {
                     ...
                     dataArray.push([value["veh_id"], value["veh_no"], value["veh_type"], value["veh_brand"], value["veh_color"], value["veh_year"], value["veh_eng_capa"]]);
                 });
                 ...
                 var head = [
                     ["#", "Vehicle Number", "Type", " Brand", "Color", "Year", "Engine Capacity"]
                 ];
                 ...
                 //x axis , y axis
                 doc.text(220, 215, "Vehicle Details");
