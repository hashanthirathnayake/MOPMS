               ...
               if(mysqli_num_rows($result)>0){
                   ...
                   while($row=mysqli_fetch_assoc($result)){
                       ...
                       $tmp=array(
                        ...
                        //    data:"mac_config_id",name:"mac_config_id"}, //data-> data value coming from the backend name -> table fields
                        //    {data:"mac_id",name:"mac_name"},
                           
                        //    {data:"pro_code",name:"pro_name"},
                        //    {data:"mac_min_qty",name:"mac_min_qty"},
                       
                        //    {data:"mac_max_qty_per_day",name:"mac_max_qty_per_day"},     // for option
                        //    {data:"mac_config_status",name:"mac_config_status"},
                        //    {data:"mac_config_id",name:"mac_config_id"}
