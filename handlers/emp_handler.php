           ...
           if($has_errors == TRUE) {
               ...
               if($mode == "add") {
                //    $sql = "INSERT INTO product_category (pro_cat_name, pro_cat_status) VALUES ('$productCatName','$productCatStatus')";
                   ...
                   $sql = "INSERT INTO employee2 ( emp_fname, emp_lname, desig_id, emp_jdate, emp_address,emp_nic,emp_email,emp_contact_no,emp_status) 
            VALUES ('$empFname','$empLname','$empDesig','$empJdate','$empAddress','$empNic','$empEmail','$empContactNo','$empStatus')";
                   ...
                   emp_jdate = '$empJdate' , emp_address = '$empAddress' , emp_nic = '$empNic' ,emp_email = '$empEmail' , emp_contact_no= '$empContactNo' ,
