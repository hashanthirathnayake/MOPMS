...
switch($type) {
    ...
    case "retrieveDeliveryScheduledList":
        ...
        $sql="SELECT concat('ORD-',lpad(tbl.`ord_code`, 6, 0)) as ORD_CODE, d.`deli_id`,d.`ord_id`,v.veh_no ,v.`veh_type`,CONCAT(e.emp_fname,' ',e.emp_lname) AS employee_name ,d.`start_date`,d.end_date , d.status
