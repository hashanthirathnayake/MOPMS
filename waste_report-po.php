			...
			<div class="table-responsive">
                        <table class="table" id="productTbl">
							<thead class="thead-light text-dark">
                                ...
                                <th scope="col"> Actual Produe Quantity</th>
...
$('#productTbl').DataTable({
    serverSide:true,
                ...
                // rowId: 'id',
                ajax:{
                    url:'handlers/wasteReport-po_handler.php?type=retrieve',
                ...
                {data:"pro_code",name:"pro_name"},
                {data:"actual_produce_qty",name:"actual_produce_qty"},
                {data:"waste_qty",name:"waste_qty"}
...
$.ajax({
url: "handlers/wasteReport-po_handler.php?type=retrieveReportDetails",
type: "POST"
}).done(function (data) {
...
dataArray.push([value["ord_id"], value["ord_detail_id"], value["pro_name"], value["actual_produce_qty"] , value["waste_qty"]  ]);
});
...
var head = [["Order No","Order Detail No","Product Name","Actual Produce Qty","Waste Qty"]];
...
doc.text(225,215,"Produce and Waste Details");
doc.line(255, 230, 335, 230);
// doc.setFontSize(15);
