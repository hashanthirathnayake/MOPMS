                    ...
                    <form action="#" id="empFrm">
                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-2 col-form-label"> First Name<span class="text-danger">*</span></label>
                                                <div class="col-10">
                                                <input class="form-control" type="text"  placeholder="first name"   name="empFname"  id="empFname">
                                            </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                <label for="example-text-input" class="col-2 col-form-label"> Last Name<span class="text-danger">*</span></label>
                                                <div class="col-10">
                                                <input class="form-control" type="text"  placeholder="last name"   name="empLname"  id="empLname">
                                            </div>
                                            </div>

                                        
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-2 col-form-label">Designation<span class="text-danger">*</span></label>
                                                                                   
                                                <div class="col-10">
                                                           

                                                            <select class="form-control" id="empDesig" name="empDesig">
                                            ...
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Join date<span class="text-danger">*</span></label>
                                                <div class="col-10">
                                                <input type="date" name="empJdate" id="empJdate" placeholder=" join date" class="form-control">
                                                </div>
                                    </div>	
                                            ...
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Address<span class="text-danger">*</span></label>
                                                    
                                                    <div class="col-10">
                                                    <input type="text" name="empAddress" id="empAddress" placeholder="Address" class="form-control">
                                                </div>
                                            </div>	
                                            
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">NIC<span class="text-danger">*</span></label>
                                                
                                                    <div class="col-10">
                                                    <input type="text" name="empNic"  id="empNic" placeholder="NIC" class="form-control">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Email<span class="text-danger">*</span></label>
                                                
                                                    <div class="col-10">
                                                    <input type="text" name="empEmail"  id="empEmail" placeholder="Email" class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-2 col-form-label">Contact No<span class="text-danger">*</span></label>
                                                
                                                <div class="col-10"> 
                                                    <input type="text" name="empContactNo"  id="empContactNo" placeholder="Contact No" class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-2 col-form-label">Remark<span class="text-danger"></span></label>
...
<script>
    ...
    $(document).ready(function(){
      ...
      $.validator.addMethod("regex", function(value, element, regexpr) {          
        ...
        $("#empSave").click(function(){
            ...
            $.ajax({
                url: 'handlers/employee_handler.php?type=saveEmployee',
                method: 'POST',
                data: data,
                processData: false,
                contentType: false
    ...
    function datab() {
        $('#empTbl').DataTable({
            ...
            columnDefs: [{
                "targets": 11, //tells DataTables which column(s) the definition should be applied to
                "data": "emp_no",
